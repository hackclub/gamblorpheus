...
class Lottery(Table, tablename="lottery", schema=None):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
async def forwards():
    ...
    manager.add_table(
        class_name="Lottery", tablename="lottery", schema=None, columns=None
    )
